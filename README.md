...
- The packaged mod metadata currently reports version `1.0.2`.
- The source tree has been refactored significantly beyond the original 1.0.2 gameplay flow, especially around branch runtime management, spectator views, and save/restore handling.
